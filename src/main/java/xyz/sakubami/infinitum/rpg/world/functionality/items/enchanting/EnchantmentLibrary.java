...
import xyz.sakubami.infinitum.rpg.world.functionality.items.enchanting.enchants.group.ProtectionEnchantment;
...
public class EnchantmentLibrary {
    ...
    static {
        ...
        PROTECTION_ALL = EnchantmentManager.register( e + "PROTECTION_ALL", new ProtectionEnchantment( Element.ALL ) );
